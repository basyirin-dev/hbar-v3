...
- **ISSUE #5 [HACKATHON PRIORITY]:** The attentional fidelity ODE relies on surface-reward pressure which currently lacks a formal definition or measurement procedure.
- **ISSUE #6 [HACKATHON PRIORITY]:** The optimal sub-state values for the executive control ODE are not formally defined for each of the five training phases.
