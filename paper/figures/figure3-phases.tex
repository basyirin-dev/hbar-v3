...
\begin{axis}[
    ...
    \begin{scope}[on background layer]
        ...
        \fill[white]   (axis cs:5,0) rectangle (axis cs:6,1.05);
        \fill[gray!8]  (axis cs:6,0) rectangle (axis cs:8,1.05);
    ...
    \begin{scope}[yshift=-18]
        ...
        \fill[signalcolor!6]  (axis cs:5,-0.15) rectangle (axis cs:6,0);
        \fill[gray!15] (axis cs:6,-0.15) rectangle (axis cs:8,0);
        \fill[signalcolor!6]  (axis cs:8,-0.15) rectangle (axis cs:10,0);
        ...
        \node[font=\footnotesize\bfseries, text=black] at (axis cs:5.5,-0.075) {P3};
    ...
    \begin{scope}[yshift=-38]
        ...
        \node[font=\footnotesize, text=gray!70] at (axis cs:5.5,-0.06) {Frontier};
